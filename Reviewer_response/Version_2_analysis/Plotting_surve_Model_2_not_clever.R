...
cumulative_effects_dat$discrim_bin = case_when(cumulative_effects_dat$discrim_notclever_bin == 1 | cumulative_effects_dat$discrim_notclever_bin == 1 | cumulative_effects_dat$discrim_notclever_bin  == 1 | cumulative_effects_dat$discrim_notclever_bin == 1 | cumulative_effects_dat$discrim_afraidothers_bin == 1 | cumulative_effects_dat$discrim_poorerservice_bin == 1 ~ 1, 
                                               cumulative_effects_dat$discrim_notclever_bin == 0 & cumulative_effects_dat$discrim_notclever_bin == 0 & cumulative_effects_dat$discrim_notclever_bin  == 0 & cumulative_effects_dat$discrim_notclever_bin == 0 & cumulative_effects_dat$discrim_afraidothers_bin == 0 & cumulative_effects_dat$discrim_poorerservice_bin == 0 ~ 0) 
...
unique(cumulative_effects_dat$discrim_notclever_bin_cat)

unique(cumulative_effects_dat$discrim_notclever_bin_cat)


cumulative_effects_dat$discrim_notclever_bin = cumulative_effects_dat$discrim_bin
#1 = 2 year 
#2 = 4 years 
#3 = 6 years 
...
fit <- coxph(Surv(follow_up, diabetes_new_bin)~ discrim_notclever_bin + continious_age + wealth_noIRA  +  assessed_BMI + hypertension_new_bin + sex_1_2, data = cumulative_effects_dat)
summary_all = summary(fit)

# coeffcients for discrim_notclever_bin: 
...
fit_female <- coxph(Surv(follow_up, diabetes_new_bin)~ discrim_notclever_bin + continious_age + wealth_noIRA  +  assessed_BMI + hypertension_new_bin , data = data_female)
...
fit_male <- coxph(Surv(follow_up, diabetes_new_bin)~ discrim_notclever_bin + continious_age + wealth_noIRA  +  assessed_BMI + hypertension_new_bin , data = data_male)
...
fit_race <- coxph(Surv(follow_up, diabetes_new_bin)~ discrim_notclever_bin + continious_age + wealth_noIRA  +  assessed_BMI + hypertension_new_bin + sex_1_2, data = data_race)
...
fit_BMI <- coxph(Surv(follow_up, diabetes_new_bin)~ discrim_notclever_bin + continious_age + wealth_noIRA  +  assessed_BMI + hypertension_new_bin + sex_1_2, data = data_BMI)
...
#write.csv(Model_2_non_interact_results, "/Users/aliya/my_docs/KCL_postDoc/Cumulative_effects/Model_2_non_interact_results_no_diab_at_baseline_discrim_bin.csv")


write.csv(Model_2_non_interact_results, paste(DATA_ROOT, "/Model_2_discrim_notclever_bin_results.csv", sep = ""))
...
# 
# 
# MODEL_2_diagnostics = rbind(numb_case_all, 
#                             AIC_all, 
#                             BIC_all, 
#                             
#                             numb_case_female,
...
# 
# 
# Model_2_analysed_n = rbind(n_all,  
#                            n_female, 
#                            n_race, 
#                            n_BMI) 
# 
# 
# Model_2_numb_case = rbind(numb_case_all,   
#                           numb_case_female, 
#                           numb_cases_race,
#                           numb_cases_BMI) 
# 
# 
# Model_2_power = rbind(res.power_all$power,  
#                       res.power_female$power, 
#                       res.power_race$power, 
#                       res.power_BMI$power) 
# 
# 
# Model_2_power_results = data.frame(Model_2_analysed_n,
#                                    Model_2_numb_case,
#                                    Model_2_power)
# 
# 
# 
# #write.csv(Model_2_power_results, "/Users/aliya/my_docs/KCL_postDoc/Cumulative_effects/Model_2_power.csv")
#
