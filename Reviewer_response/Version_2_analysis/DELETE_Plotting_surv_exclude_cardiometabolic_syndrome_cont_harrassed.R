...
#### plot for the entire dataset (discrim_harassed): 

fit <- survreg(Surv(follow_up, diabetes_new_bin) ~ discrim_harassed, data = cumulative_effects_dat, dist="weibull")
...
write.csv(summary_all_table, paste(OUTPUT_ROOT, "continious_summary_all_table_discrim_harassed_no_cardiomet_disease.csv")) 
...
write.csv(All_results_unadjusted, paste(OUTPUT_ROOT, "continious_All_results_unadjusted_discrim_harassed_no_cardiomet_disease.csv", sep = "")) 
