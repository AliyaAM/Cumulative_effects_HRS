...
fit <- coxph(Surv(follow_up, diabetes_new_bin)~ discrim_poorerservice_bin + continious_age + wealth_noIRA+ sex_1_2 + checklist_depression_bin, data = cumulative_effects_dat)
...
fit_female <- coxph(Surv(follow_up, diabetes_new_bin)~ discrim_poorerservice_bin + continious_age + wealth_noIRA+ checklist_depression_bin  , data = data_female)
...
fit_male <- coxph(Surv(follow_up, diabetes_new_bin)~ discrim_poorerservice_bin + continious_age + wealth_noIRA+ checklist_depression_bin  , data = data_male)
...
fit_race <- coxph(Surv(follow_up, diabetes_new_bin)~ discrim_poorerservice_bin + continious_age + wealth_noIRA+ sex_1_2 + checklist_depression_bin, data = data_race)
...
fit_BMI <- coxph(Surv(follow_up, diabetes_new_bin)~ discrim_poorerservice_bin + continious_age + wealth_noIRA+ sex_1_2 + checklist_depression_bin, data = data_BMI)
...
write.csv(Model_5_non_interact_results, "/Users/aliya/my_docs/proj/Cumulative_effects_HRS/Results/situations/Model_5_discrim_poorerservice_bin_results.csv")
