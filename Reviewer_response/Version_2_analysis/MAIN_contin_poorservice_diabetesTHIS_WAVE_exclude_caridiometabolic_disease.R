...
OUTPUT_ROOT = paste(current_directory, "proj/Cumulative_effects_HRS/Reviewer_response/Version_2_analysis/RESULTS/poorerservice_cont/", sep="")
...
##### Harassed, Less respect, Medical, Not clever, Poor service 	
...
### HRS2008_data_initial_old$discrim_poorerservice
