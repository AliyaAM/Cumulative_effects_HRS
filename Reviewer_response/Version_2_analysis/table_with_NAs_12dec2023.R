...
print("fix smoking, also make sure that we are including the 14901 unique IDs at baseline")
...
# non_diabetes_baseline_and1 = full_join( non_diabetes_baseline, 
...
# diabetes_baseline_and1 = full_join( diabetes_baseline,
#                                        diabetes_followup_1,
# 
#                                        suffix = c("", "_new"),
# 
...
### subset each dataset further into those with NAs and with complete follow-up: data_ttest, group1, group2
...
nrow(baseline_included_cohort_developed_diabetes)
nrow(baseline_included_cohort_didnot_develop_diabetes)
##############
##############
##############
...
unique(dataset_compared$diabetes_new) 
unique(dataset_compared$developed_diabetes)

nrow(dataset_compared)
head(dataset_compared)
