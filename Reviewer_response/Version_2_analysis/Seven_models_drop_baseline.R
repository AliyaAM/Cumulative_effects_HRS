...
Seven_models_drop_baseline = function (subset_var1, 
  ...
  Model_1 = c("continious_age", "wealth_noIRA", "sex_1_2",  "race_white" )
  #Model 2: age, sex, wealth, BMI, hypertension  [basic adjustment + diabetes risk factors]
  Model_2 = c("continious_age", "wealth_noIRA", "sex_1_2", "assessed_BMI", "hypertension_new_bin", "race_white" )
  ...
  Model_3 = c("continious_age", "wealth_noIRA", "sex_1_2",   "vigarious_physical_activity_new", "race_white" )
  ...
  Model_5 = c("continious_age","wealth_noIRA", "sex_1_2", "checklist_depression_bin", "race_white")
