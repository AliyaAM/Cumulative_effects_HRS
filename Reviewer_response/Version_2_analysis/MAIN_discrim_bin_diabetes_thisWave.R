...
OUTPUT_ROOT =(paste(current_directory, "/data_files/Results/Reason_discrim/reason_exposure/diabetes_thisWAVE/", sep=""))
...
all_ageism_discrim_bin_diabetes_thisWAVE_7models = Seven_models(subset_var1 = "NA", 
                                                           subset_value1 = "NA", 
...
write.csv(all_ageism_discrim_bin_diabetes_thisWAVE_7models, paste(OUTPUT_ROOT, "all_ageism_discrim_bin_diabetes_thisWAVE.csv", sep=""))


all_ageism_discrim_bin_diabetes_thisWAVE_7models_pvalues = p_value_func(data = all_ageism_discrim_bin_diabetes_thisWAVE_7models,
                                                                   subset_name = "all_ageism", 
                                                                   Model = Model)


female_sexism_discrim_bin_diabetes_thisWAVE_7models = Seven_models(subset_var1 = "sex_1_2", 
                                                              subset_value1 = 2, 
...
write.csv(female_sexism_discrim_bin_diabetes_thisWAVE_7models, paste(OUTPUT_ROOT, "female_sexism_discrim_bin_diabetes_thisWAVE.csv", sep=""))




female_sexism_discrim_bin_diabetes_thisWAVE_7models_pvalues = p_value_func(data = female_sexism_discrim_bin_diabetes_thisWAVE_7models,
                                                                      subset_name = "FEMALE_sexism", 
                                                                      Model = Model)
...
race_racism_discrim_bin_diabetes_thisWAVE_7models = Seven_models(subset_var1 = "race_white", 
                                                            subset_value1 = 0, 
...
write.csv(race_racism_discrim_bin_diabetes_thisWAVE_7models, paste(OUTPUT_ROOT, "race_racism_discrim_bin_diabetes_thisWAVE.csv", sep=""))



race_racism_discrim_bin_diabetes_thisWAVE_7models_pvalues = p_value_func(data = race_racism_discrim_bin_diabetes_thisWAVE_7models,
                                                                    subset_name = "race_racism", 
                                                                    Model = Model)



combo_reason_discrim_bin_diabetes_thisWAVE_7models = Seven_models(subset_var1 = "race_white", 
                                                             subset_value1 = 0, 
...
write.csv(combo_reason_discrim_bin_diabetes_thisWAVE_7models, paste(OUTPUT_ROOT, "combo_discrim_bin_diabetes_thisWAVE.csv", sep=""))




Combo_discrim_bin_diabetes_thisWAVE_7models_pvalues = p_value_func(data = combo_reason_discrim_bin_diabetes_thisWAVE_7models,
                                                              subset_name = "Combo_reason", 
                                                              Model = Model)
...
write.csv(results_reason_col, paste(OUTPUT_ROOT, "result_reason_table_diabetes_thisWAVE.csv", sep=""))
