...
race_discrim_bin_Model_11 = summary_score_WCE_analysis(data_WCE = data_wce_race,
                                                       exposure = "discrim_bin", 
                                                       outcome = "diabetes_new_bin", 
                                                       covariates_list = Model_11)


race_discrim_bin_HR_Model_11 = race_discrim_bin_Model_11[1]

race_discrim_bin_Model_11_stats_recoded = race_discrim_bin_Model_11[2]
...
race_discrim_bin_age_CI_Model_11  = summary_score_Bootstrapped_CI(WCE_data_CI = data_wce_race,
                                                                  exposure = "discrim_bin", 
                                                                  outcome = "diabetes_new_bin",
                                                                  covariates_list = Model_11)


write.csv(race_discrim_bin_Model_11_stats_recoded, paste(OUTPUT_ROOT, "stats/race_discrim_BIN_Model_11_stats.csv", sep=""))


race_discrim_bin_HR_Model_11 = unlist(race_discrim_bin_HR_Model_11)
race_discrim_bin_results_Model_11 = cbind(race_discrim_bin_HR_Model_11, race_discrim_bin_age_CI_Model_11)

colnames(race_discrim_bin_results_Model_11) = c("hazard ratio", "5% CI", "95% CI")



write.csv(race_discrim_bin_results_Model_11, paste(OUTPUT_ROOT, "race_discrim_BIN_results_Model_11.csv", sep=""))
