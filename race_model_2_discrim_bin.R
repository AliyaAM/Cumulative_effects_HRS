...
Model_20 = c("assessed_BMI", "continious_age", "CVD", "hypertension_new_bin")
Model_21 = c("assessed_BMI", "continious_age", "CVD","alcohol_days_week_new",  "vigarious_physical_activity_new", "smokes_now_bin")
Model_22 = c("assessed_BMI", "continious_age", "CVD","alcohol_days_week_new",  "vigarious_physical_activity_new", "smokes_now_bin", "hypertension_new_bin")
Model_23 = c("assessed_BMI", "continious_age", "checklist_depression_bin")
Model_24 = c("assessed_BMI", "continious_age", "checklist_depression_bin", "alcohol_days_week_new",  "vigarious_physical_activity_new", "smokes_now_bin")
Model_25 = c("assessed_BMI", "continious_age", "hypertension_new_bin", "checklist_depression_bin")
Model_26 = c("assessed_BMI", "continious_age", "hypertension_new_bin", "CVD", "checklist_depression_bin")
Model_27 = c("assessed_BMI", "continious_age", "hypertension_new_bin", "CVD", "checklist_depression_bin", "alcohol_days_week_new",  "vigarious_physical_activity_new", "smokes_now_bin")
...
race_discrim_bin_Model_2 = summary_score_WCE_analysis(data_WCE = data_wce_race,
                                                      exposure = "discrim_bin", 
                                                      outcome = "diabetes_new_bin", 
                                                      covariates_list = Model_2)


race_discrim_bin_HR_Model_2 = race_discrim_bin_Model_2[1]

race_discrim_bin_Model_2_stats_recoded = race_discrim_bin_Model_2[2]
...
race_discrim_bin_age_CI_Model_2  = summary_score_Bootstrapped_CI(WCE_data_CI = data_wce_race,
                                                                 exposure = "discrim_bin", 
                                                                 outcome = "diabetes_new_bin",
                                                                 covariates_list = Model_2)


write.csv(race_discrim_bin_Model_2_stats_recoded, paste(OUTPUT_ROOT, "stats/race_discrim_BIN_Model_2_stats.csv", sep=""))


race_discrim_bin_HR_Model_2 = unlist(race_discrim_bin_HR_Model_2)
race_discrim_bin_results_Model_2 = cbind(race_discrim_bin_HR_Model_2, race_discrim_bin_age_CI_Model_2)

colnames(race_discrim_bin_results_Model_2) = c("hazard ratio", "5% CI", "95% CI")



write.csv(race_discrim_bin_results_Model_2, paste(OUTPUT_ROOT, "race_discrim_BIN_results_Model_2.csv", sep=""))
