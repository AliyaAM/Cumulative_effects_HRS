...
source((paste(SOURCE_ROOT, "female_model_7.R", sep="")))

source((paste(SOURCE_ROOT, "BMI_model_7.R", sep="")))

source((paste(SOURCE_ROOT, "race_model_7.R", sep="")))

source((paste(SOURCE_ROOT, "religion_model_7.R", sep="")))

source((paste(SOURCE_ROOT, "national_origin_model_7.R", sep="")))
