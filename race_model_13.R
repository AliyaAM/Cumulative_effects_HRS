...
race_discrim_harassed_bin_model_13_stats_recoded = race_discrim_harassed_bin_age[2]
...
write.csv(race_discrim_harassed_bin_model_13_stats_recoded, paste(OUTPUT_ROOT, "stats/race_overal_discrim_model_13_stats_recoded.csv", sep=""))
...
race_discrim_lessrespect_bin_model_13_stats_recoded = race_discrim_lessrespect_bin_age[2]
...
write.csv(race_discrim_lessrespect_bin_model_13_stats_recoded, paste(OUTPUT_ROOT, "stats/race_discrim_lessrespect_bin_model_13_stats_recoded.csv", sep=""))
...
race_discrim_medical_bin_model_13_stats_recoded = race_discrim_medical_bin_age[2]
...
write.csv(race_discrim_medical_bin_model_13_stats_recoded, paste(OUTPUT_ROOT, "stats/race_discrim_medical_bin_model_13_stats_recoded.csv", sep=""))
...
race_discrim_notclever_bin_model_13_stats_recoded = race_discrim_notclever_bin_age[2]
...
write.csv(race_discrim_notclever_bin_model_13_stats_recoded, paste(OUTPUT_ROOT, "stats/race_discrim_notclever_bin_model_13_stats_recoded.csv", sep=""))
...
race_discrim_poorerservice_bin_model_13_stats_recoded = race_discrim_poorerservice_bin_age[2]
...
write.csv(race_discrim_poorerservice_bin_model_13_stats_recoded, paste(OUTPUT_ROOT, "stats/race_discrim_poorerservice_bin_model_13_stats_recoded.csv", sep=""))
...
race_afraid_others_model_13_stats_recoded = race_afraid_others_age[2]
...
write.csv(race_afraid_others_model_13_stats_recoded, paste(OUTPUT_ROOT, "stats/race_afraid_others_model_13_stats_recoded.csv", sep=""))
...
write.csv(race_all_results, paste(OUTPUT_ROOT, "race_all_results_bin_model_13_test.csv", sep=""))
