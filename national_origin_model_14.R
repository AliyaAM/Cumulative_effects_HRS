...
# Model 17: age, national_origin_ousideUS, smoking, physical activity, alcohol consumption, depression
# Model 18: age, national_origin_ousideUS, smoking, physical activity, alcohol consumption, CVD, hypertension, depression  (8)
#######
...
national_origin_ousideUS_discrim_harassed_bin_model_14_stats_recoded = national_origin_ousideUS_discrim_harassed_bin_age[2]
...
write.csv(national_origin_ousideUS_discrim_harassed_bin_model_14_stats_recoded, paste(OUTPUT_ROOT, "stats/national_origin_ousideUS_overal_discrim_model_14_stats_recoded.csv", sep=""))
...
national_origin_ousideUS_discrim_lessrespect_bin_model_14_stats_recoded = national_origin_ousideUS_discrim_lessrespect_bin_age[2]
...
write.csv(national_origin_ousideUS_discrim_lessrespect_bin_model_14_stats_recoded, paste(OUTPUT_ROOT, "stats/national_origin_ousideUS_discrim_lessrespect_bin_model_14_stats_recoded.csv", sep=""))
...
national_origin_ousideUS_discrim_medical_bin_model_14_stats_recoded = national_origin_ousideUS_discrim_medical_bin_age[2]
...
write.csv(national_origin_ousideUS_discrim_medical_bin_model_14_stats_recoded, paste(OUTPUT_ROOT, "stats/national_origin_ousideUS_discrim_medical_bin_model_14_stats_recoded.csv", sep=""))
...
national_origin_ousideUS_discrim_notclever_bin_model_14_stats_recoded = national_origin_ousideUS_discrim_notclever_bin_age[2]
...
write.csv(national_origin_ousideUS_discrim_notclever_bin_model_14_stats_recoded, paste(OUTPUT_ROOT, "stats/national_origin_ousideUS_discrim_notclever_bin_model_14_stats_recoded.csv", sep=""))
...
national_origin_ousideUS_discrim_poorerservice_bin_model_14_stats_recoded = national_origin_ousideUS_discrim_poorerservice_bin_age[2]
...
write.csv(national_origin_ousideUS_discrim_poorerservice_bin_model_14_stats_recoded, paste(OUTPUT_ROOT, "stats/national_origin_ousideUS_discrim_poorerservice_bin_model_14_stats_recoded.csv", sep=""))
...
national_origin_ousideUS_afraid_others_model_14_stats_recoded = national_origin_ousideUS_afraid_others_age[2]
...
write.csv(national_origin_ousideUS_afraid_others_model_14_stats_recoded, paste(OUTPUT_ROOT, "stats/national_origin_ousideUS_afraid_others_model_14_stats_recoded.csv", sep=""))
...
write.csv(national_origin_ousideUS_all_results, paste(OUTPUT_ROOT, "national_origin_ousideUS_all_results_bin_model_14_test.csv", sep=""))
