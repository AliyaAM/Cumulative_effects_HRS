...
WCE_dataset_BMI = read.csv(paste(SOURCE_data_ROOT, "WCE_dataset_BMI_depression.csv", sep=""))
...
unique(data_wce_BMI$checklist_depression_bin)
...
write.csv(BMI_overal_discrim_stats, paste(OUTPUT_ROOT, "stats/BMI_overal_discrim_stats_depression.csv", sep=""))
...
write.csv(BMI_discrim_harassed_stats, paste(OUTPUT_ROOT, "stats/BMI_discrim_harassed_age_stats_depression.csv", sep=""))
...
write.csv(BMI_discrim_lessrespect_stats, paste(OUTPUT_ROOT, "stats/BMI_discrim_lessrespect_age_stats_depression.csv", sep=""))
...
write.csv(BMI_discrim_medical_stats, paste(OUTPUT_ROOT, "stats/BMI_discrim_medical_stats_depression.csv", sep=""))
...
write.csv(BMI_discrim_notclever_stats, paste(OUTPUT_ROOT, "stats/BMI_discrim_notclever_stats_depression.csv", sep=""))
...
write.csv(BMI_discrim_poorerservice_stats, paste(OUTPUT_ROOT, "stats/MI_discrim_poorerservice_stats_depression.csv", sep=""))
...
write.csv(BMI_afraid_others_age_stats, paste(OUTPUT_ROOT, "stats/BMI_afraid_others_age_stats_depression.csv", sep=""))
...
write.csv(BMI_all_results, paste(OUTPUT_ROOT, "BMI_all_results_depression.csv", sep=""))
