...
HRS2018_data_national_origin_discrim = na.omit(HRS2018_data_national_origin_discrim)
HRS2016_data_national_origin_discrim = na.omit(HRS2016_data_national_origin_discrim)
HRS2014_data_national_origin_discrim = na.omit(HRS2014_data_national_origin_discrim)
HRS2012_data_national_origin_discrim = na.omit(HRS2012_data_national_origin_discrim)
HRS2010_data_national_origin_discrim = na.omit(HRS2010_data_national_origin_discrim)
HRS2008_data_national_origin_discrim = na.omit(HRS2008_data_national_origin_discrim)
