...
fit <- coxph(Surv(follow_up, diabetes_new_bin)~ discrim_poorerservice_bin + continious_age * wealth_noIRA * sex_1_2, data = cumulative_effects_dat)
...
#write.csv(All_results_Model_1, paste(DATA_ROOT, "/Model1_All_discrim_poorerservice_bin_cat.csv", sep = ""))
...
fit_female <- coxph(Surv(follow_up, diabetes_new_bin)~ discrim_poorerservice_bin + continious_age * wealth_noIRA, data = data_female)
...
fit_male <- coxph(Surv(follow_up, diabetes_new_bin)~ discrim_poorerservice_bin + continious_age * wealth_noIRA, data = data_male)
...
fit_race <- coxph(Surv(follow_up, diabetes_new_bin)~ discrim_poorerservice_bin + continious_age * wealth_noIRA * sex_1_2, data = data_race)
...
fit_BMI <- coxph(Surv(follow_up, diabetes_new_bin)~ discrim_poorerservice_bin + continious_age * wealth_noIRA * sex_1_2, data = data_BMI)
...
write.csv(Model_1_results, paste(DATA_ROOT, "/Model1_discrim_poorerservice_bin_cat.csv", sep = ""))
