...
mod_cb <- fitSmoothHazard(diabetes_new_bin ~ log(years) + discrimination + continious_age + wealth_noIRA + sex_1_2,
...
mod_cb_female <- fitSmoothHazard(diabetes_new_bin ~ log(years) + discrimination + continious_age + wealth_noIRA,
                                 data = data_female,
                                 time = "timepoints_indiv")
...
mod_cb_race <- fitSmoothHazard(diabetes_new_bin ~ continious_age + wealth_noIRA + sex_1_2 + log(years) + discrimination,
                               data = data_race,
                               time = "timepoints_indiv")
...
mod_cb_BMI <- fitSmoothHazard(diabetes_new_bin ~ log(years) + discrimination + continious_age + wealth_noIRA + sex_1_2,
                              data = data_BMI,
                              time = "timepoints_indiv")
