...
#Model 1: age and sex, wealth  [basis adjustment]
Model_4_non_interact_nosex = c("continious_age", "wealth_noIRA")
#Model 2: age, sex, wealth, BMI, hypertension  [basic adjustment + diabetes risk factors]
Model_4_non_interact_nosex = c("continious_age", "wealth_noIRA",  "assessed_BMI", "hypertension_new_bin")
#Model 3: age, sex, wealth, physical activity, smoking (yes/no), and alcohol (days/week) [basic adjustment + health behaviours]
Model_4_nosex = c("continious_age", "wealth_noIRA", "alcohol_days_week_new",  "vigarious_physical_activity_new", 'smokes_now_bin')
#Model 4: age, sex, wealth, CVD  [basic adjustment + CVD most common diabetes co_morbidity]
...
fit <- coxph(Surv(years, diabetes_new_bin)~ discrimination + continious_age + wealth_noIRA + sex_1_2 + CVD , data = cumulative_effects_dat)
...
#write.csv(All_results_Model_4_non_interact, "/Users/aliya/my_docs/KCL_postDoc/Cumulative_effects/All_results_Model_4_non_interact.csv")
...
#write.csv(Female_results_Model_4_non_interact, "/Users/aliya/my_docs/KCL_postDoc/Cumulative_effects/Female_results_Model_4_non_interact.csv")
...
male_results_Model_4_non_interact$subset  = c("male")
...
#write.csv(male_results_Model_4_non_interact, "/Users/aliya/my_docs/KCL_postDoc/Cumulative_effects/male_results_Model_4_non_interact.csv")
...
write.csv(Model_4_non_interact_results, "/Users/aliyaamirova/Documents/KCL_postDoc/Data_analysis/Cumulative_effects_laptop/Model_4_non_interact_results_nodiab_two_waves_discrim_bin.csv")
