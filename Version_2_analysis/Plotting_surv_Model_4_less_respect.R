...
fit_all <- coxph(Surv(follow_up, diabetes_new_bin)~ discrim_lessrespect_bin + continious_age + wealth_noIRA + sex_1_2 + CVD , data = cumulative_effects_dat)
...
fit_female <- coxph(Surv(follow_up, diabetes_new_bin)~ discrim_lessrespect_bin + continious_age + wealth_noIRA + sex_1_2 + CVD , data = data_female)
...
fit_male <- coxph(Surv(follow_up, diabetes_new_bin)~ discrim_lessrespect_bin + continious_age + wealth_noIRA + sex_1_2 + CVD , data = data_male)
...
fit_race <- coxph(Surv(follow_up, diabetes_new_bin)~ discrim_lessrespect_bin + continious_age + wealth_noIRA + sex_1_2 + CVD , data = data_race)
...
fit_BMI <- coxph(Surv(follow_up, diabetes_new_bin)~ discrim_lessrespect_bin + continious_age + wealth_noIRA + sex_1_2 + CVD , data = data_BMI)
...
write.csv(Model_4_non_interact_results, "/Users/aliya/my_docs/proj/Cumulative_effects_HRS/Results/situations/Model_4_discrim_lessrespect_bin_results.csv")
