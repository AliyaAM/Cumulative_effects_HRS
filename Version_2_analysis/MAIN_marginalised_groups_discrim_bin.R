...
subset = rep("BMI", times = nrow(BMI_discrim_bin_diabetes_new_7models))


BMI_discrim_bin_diabetes_new_7models = cbind(subset, Model, BMI_discrim_bin_diabetes_new_7models)
