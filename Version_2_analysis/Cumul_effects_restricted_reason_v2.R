...
source((paste(SOURCE_ROOT, "subset_sort_BMI_version_2.R", sep="")))
...
female_dataset = subset_sort_var1_and_var2(subset_var1 = "sex_1_2", 
                                           subset_value1 = 2,
...
BMI_dataset = subset_sort_BMI_version_2(subset_var1 = "assessed_BMI", 
                                        subset_value1 = 30,
...
#self-reported
national_origin_dataset = subset_sort_var1_and_var2(subset_var1 = "national_origin_ousideUS_bin", 
                                                    subset_value1 = 1,
                                                    subset_var2 = "reason_discrim1_reason_national", 
                                                    subset_value2 = 1) 

#self-reported
race_dataset = subset_sort_var1_and_var2(subset_var1 = "race_white", 
                                         subset_value1 = 0,
                                         subset_var2 = "reason_discrim1_reason_race", 
                                         subset_value2 = 1) 

#self-reported
religion_dataset = subset_sort_var1_and_var2(subset_var1 = "religion_bin", 
                                             subset_value1 = 1,
...
write.csv(female_results_discrim_bin, paste(OUTPUT_ROOT, "female_results_discrim_binrestricted_reason_V2.csv", sep=""))
...
write.csv(female_results_discrim_bin_table_col, paste(OUTPUT_ROOT, "female_results_discrim_bin_table_colrestricted_reason_V2.csv", sep=""))
...
write.csv(national_origin_results_discrim_bin, paste(OUTPUT_ROOT, "national_origin_results_discrim_binrestricted_reason_V2.csv", sep=""))
...
write.csv(national_origin_results_discrim_bin_table_col, paste(OUTPUT_ROOT, "national_origin_results_discrim_bin_table_colrestricted_reason_V2.csv", sep=""))
...
write.csv(race_results_discrim_bin, paste(OUTPUT_ROOT, "race_results_discrim_binrestricted_reason_V2.csv", sep=""))
...
write.csv(race_results_discrim_bin_table_col, paste(OUTPUT_ROOT, "race_results_discrim_bin_table_colrestricted_reason_V2.csv", sep=""))
...
write.csv(religion_results_discrim_bin, paste(OUTPUT_ROOT, "religion_results_discrim_binrestricted_reason_V2.csv", sep=""))
...
write.csv(religion_results_discrim_bin_table_col, paste(OUTPUT_ROOT, "religion_results_discrim_bin_table_colrestricted_reason_V2.csv", sep=""))
