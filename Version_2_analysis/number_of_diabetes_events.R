...
OUTPUT_ROOT ="/Users/aliyaamirova/Documents/KCL_postDoc/Data_analysis/Cumulative_effects_laptop/Results/Version_4/"
...
write.csv(new_diabetes_each_wave, (paste(OUTPUT_ROOT, "new_diabetes_each_wave.csv", sep="")))
...
write.csv(numbers, (paste(OUTPUT_ROOT, "diabetes_new_cases_in_each_subset.csv", sep="")))
