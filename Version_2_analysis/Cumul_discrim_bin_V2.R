  ...
  clean_recode_sort = function (subset_var,
                                subset_value, 
                                HRS2008_data_intermediate, 
                                HRS2010_data_intermediate, 
                                HRS2012_data_intermediate, 
                                HRS2014_data_intermediate, 
                                HRS2016_data_intermediate, 
                                HRS2018_data_intermediate){
