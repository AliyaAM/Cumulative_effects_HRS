...
female_dataset = subset_func(subset_var = "sex_1_2", 
                             subset_value = 2, 
...
#self_reported
national_origin_dataset = subset_func(subset_var = "national_origin_ousideUS_bin", 
                                                    subset_value = 1, 
...
#self_reported
religion_dataset = subset_func(subset_var = "religion_bin", 
                                             subset_value = 1, 
...
female_dataset$WCE_dataset_subset
