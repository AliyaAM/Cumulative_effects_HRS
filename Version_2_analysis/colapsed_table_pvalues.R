...
race_national_origin_religion_results = read.csv(paste(OUTPUT_ROOT, "race_national_origin_religion_results_discrim_binrestricted_V2.csv", sep=""))
race_national_origin_religion_results$Model = c(1, 2, 3, 4, 5, 6, 7)
race_national_origin_religion_results$subset = rep("race_national_origin_religion_results", times = nrow(race_national_origin_religion_results))


race_national_origin_results = read.csv(paste(OUTPUT_ROOT, "race_national_origin_results_discrim_binrestricted_V2.csv", sep=""))

race_national_origin_results$Model = c(1, 2, 3, 4, 5, 6, 7)
race_national_origin_results$subset = rep("race_national_origin_results", times = nrow(race_national_origin_results))
...
diabetes_results_discrim_bin = rbind(race_national_origin_results,
                                     race_national_origin_religion_results) 
...
write.csv(diabetes_results_HRs_only, paste(OUTPUT_ROOT, "race_national_origin_religion_V2_HRs_only.csv", sep=""))
