...
fit <- coxph(Surv(follow_up, diabetes_new_bin)~ discrim_harassed_bin + continious_age + wealth_noIRA + sex_1_2 + alcohol_days_week_new +  vigarious_physical_activity_new + smokes_now_bin , data = cumulative_effects_dat)
...
fit_female <- coxph(Surv(follow_up, diabetes_new_bin)~ discrim_harassed_bin + continious_age + wealth_noIRA + alcohol_days_week_new +  vigarious_physical_activity_new + smokes_now_bin  , data = data_female)
...
fit_male <- coxph(Surv(follow_up, diabetes_new_bin)~ discrim_harassed_bin + continious_age + wealth_noIRA + alcohol_days_week_new +  vigarious_physical_activity_new + smokes_now_bin  , data = data_male)
...
fit_race <- coxph(Surv(follow_up, diabetes_new_bin)~ discrim_harassed_bin + continious_age + wealth_noIRA + sex_1_2 + alcohol_days_week_new +  vigarious_physical_activity_new + smokes_now_bin , data = data_race)
...
fit_BMI <- coxph(Surv(follow_up, diabetes_new_bin)~ discrim_harassed_bin + continious_age + wealth_noIRA + sex_1_2 + alcohol_days_week_new +  vigarious_physical_activity_new + smokes_now_bin , data = data_BMI)
...
write.csv(Model_3_non_interact_results, "/Users/aliya/my_docs/proj/Cumulative_effects_HRS/Results/situations/Model_3_discrim_harassed_bin_results.csv")
