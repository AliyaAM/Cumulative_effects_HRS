...
write.csv(new_diabetes_each_wave, (paste(OUTPUT_ROOT, "new_diabetes_each_wave_DIAB_restricted_reason.csv", sep="")))
...
write.csv(numbers, (paste(OUTPUT_ROOT, "diabetes_new_cases_DIAB_in_each_subset_restricted_reason.csv", sep="")))
