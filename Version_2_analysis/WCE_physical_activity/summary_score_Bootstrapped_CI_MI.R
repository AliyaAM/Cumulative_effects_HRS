...
summary_score_Bootstrapped_CI = function (data_wce_subset, 
  ...
  data_wce_subset$heartattack_new_bin = as.numeric(data_wce_subset$heartattack_new_bin)
  data_wce_subset$vigarious_physical_activity_bin = as.numeric(data_wce_subset$vigarious_physical_activity_bin)
    ...
    mod <- tryCatch(
      {
        ...
        WCE(data = sample_df,
            ...
            id = "HHIDPN",
            event = "heartattack_new_bin",
            start = "start_new",
            stop = "stop_new",
            expos = "vigarious_physical_activity_bin",
      ...
      error=function(cond) {
        ...
        message("---")
        message(paste("length(sample_df[heartattack_new_bin])", length(sample_df$heartattack_new_bin), sep=": "))
        
        message("---")
        message(paste("length(sample_df[vigarious_physical_activity_bin])", length(sample_df$vigarious_physical_activity_bin), sep=": "))
        ...
        # }
        message("---")
        print(class(sample_df$heartattack_new_bin))
        message("---")
        print(class(sample_df$vigarious_physical_activity_bin))
        message("---")
        ...
        message("---")
        print(unique(sample_df$heartattack_new_bin))
        ...
        message("---")
        print(checkWCE(sample_df, id = "HHIDPN", event = "heartattack_new_bin",  start = "start_new", stop = "stop_new", expos = "vigarious_physical_activity_bin"))
        message("---")
