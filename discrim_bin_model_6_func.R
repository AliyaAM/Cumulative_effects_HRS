...
discrim_bin_model_func = function (subset_var, subset_value, Model_n){
...
folder = paste(subset_var, Model_n, "/", sep = "")

dir.create(paste(path, folder, sep = ""))

write.csv(subset_discrim_bin_subset_stats_recoded, paste(OUTPUT_ROOT, folder, "stats/subset_discrim_BIN_subset_stats.csv", sep=""))
