...
national_origin_ousideUS_discrim_harassed_bin_model_3_stats_recoded = national_origin_ousideUS_discrim_harassed_bin_age[2]
...
write.csv(national_origin_ousideUS_discrim_harassed_bin_model_3_stats_recoded, paste(OUTPUT_ROOT, "stats/national_origin_ousideUS_overal_discrim_model_3_stats_recoded.csv", sep=""))
...
national_origin_ousideUS_discrim_lessrespect_bin_model_3_stats_recoded = national_origin_ousideUS_discrim_lessrespect_bin_age[2]
...
national_origin_ousideUS_discrim_lessrespect_bin_age_CI  = summary_score_Bootstrapped_CI(WCE_data_CI = data_wce_national_origin_ousideUS,
                                                                                         ...
                                                                                         outcome = "diabetes_new_bin", 
                                                                                         covariates_list = c("assessed_BMI", "continious_age", "wealth_noIRA"))
                                                                                         #covariates_list = c("assessed_BMI", "continious_age")) #covariates_list = c("continious_age"))

write.csv(national_origin_ousideUS_discrim_lessrespect_bin_model_3_stats_recoded, paste(OUTPUT_ROOT, "stats/national_origin_ousideUS_discrim_lessrespect_bin_model_3_stats_recoded.csv", sep=""))
...
national_origin_ousideUS_discrim_medical_bin_model_3_stats_recoded = national_origin_ousideUS_discrim_medical_bin_age[2]
...
write.csv(national_origin_ousideUS_discrim_medical_bin_model_3_stats_recoded, paste(OUTPUT_ROOT, "stats/national_origin_ousideUS_discrim_medical_bin_model_3_stats_recoded.csv", sep=""))
...
national_origin_ousideUS_discrim_notclever_bin_model_3_stats_recoded = national_origin_ousideUS_discrim_notclever_bin_age[2]
...
write.csv(national_origin_ousideUS_discrim_notclever_bin_model_3_stats_recoded, paste(OUTPUT_ROOT, "stats/national_origin_ousideUS_discrim_notclever_bin_model_3_stats_recoded.csv", sep=""))
...
national_origin_ousideUS_discrim_poorerservice_bin_model_3_stats_recoded = national_origin_ousideUS_discrim_poorerservice_bin_age[2]
...
write.csv(national_origin_ousideUS_discrim_poorerservice_bin_model_3_stats_recoded, paste(OUTPUT_ROOT, "stats/national_origin_ousideUS_discrim_poorerservice_bin_model_3_stats_recoded.csv", sep=""))
...
national_origin_ousideUS_afraid_others_model_3_stats_recoded = national_origin_ousideUS_afraid_others_age[2]
...
write.csv(national_origin_ousideUS_afraid_others_model_3_stats_recoded, paste(OUTPUT_ROOT, "stats/national_origin_ousideUS_afraid_others_model_3_stats_recoded.csv", sep=""))
...
write.csv(national_origin_ousideUS_all_results, paste(OUTPUT_ROOT, "national_origin_ousideUS_all_results_bin_model_3.csv", sep=""))
