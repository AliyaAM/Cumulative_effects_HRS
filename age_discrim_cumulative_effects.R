...
unique(WCE_dataset_age_discrim$discrim_poorerservice)
unique(WCE_dataset_age_discrim$discrim_afraidothers)
unique(WCE_dataset_age_discrim$wealth_noIRA)
unique(WCE_dataset_age_discrim$assessed_BMI)

WCE_dataset_age_discrim$diabetes_new_bin = as.numeric(WCE_dataset_age_discrim$diabetes_new_bin)

WCE_dataset_age_discrim$summary_mean_score_discrim = as.numeric(WCE_dataset_age_discrim$summary_mean_score_discrim)

WCE_dataset_age_discrim$discrim_harassed = as.numeric(WCE_dataset_age_discrim$discrim_harassed)
WCE_dataset_age_discrim$discrim_lessrespect = as.numeric(WCE_dataset_age_discrim$discrim_lessrespect)
WCE_dataset_age_discrim$discrim_medical = as.numeric(WCE_dataset_age_discrim$discrim_medical)
WCE_dataset_age_discrim$discrim_notclever = as.numeric(WCE_dataset_age_discrim$discrim_notclever)
WCE_dataset_age_discrim$discrim_poorerservice = as.numeric(WCE_dataset_age_discrim$discrim_poorerservice)
WCE_dataset_age_discrim$discrim_afraidothers = as.numeric(WCE_dataset_age_discrim$discrim_afraidothers)

WCE_dataset_age_discrim$wealth_noIRA = as.numeric(WCE_dataset_age_discrim$wealth_noIRA)
WCE_dataset_age_discrim$assessed_BMI = as.numeric(WCE_dataset_age_discrim$assessed_BMI)
WCE_dataset_age_discrim$continious_age = as.numeric(WCE_dataset_age_discrim$continious_age)
