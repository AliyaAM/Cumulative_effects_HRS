...
#HRS2018disability_discrim_hispanic_latino

#HRS2018disability_discrim_white
#HRS2018disability_discrim_black
#LGB_2016
#Straight_2016
#sex_1_0_2018
...
HRS2008_data_disability_discrim = subset(HRS2008_data, HRS2008_data$reason_discrim1_reason_disability == 1) 
HRS2010_data_disability_discrim = subset(HRS2010_data, HRS2010_data$reason_discrim1_reason_disability == 1)
HRS2012_data_disability_discrim = subset(HRS2012_data, HRS2012_data$reason_discrim1_reason_disability == 1)
HRS2014_data_disability_discrim = subset(HRS2014_data, HRS2014_data$reason_discrim1_reason_disability == 1)
HRS2016_data_disability_discrim = subset(HRS2016_data, HRS2016_data$reason_discrim1_reason_disability == 1)
HRS2018_data_disability_discrim = subset(HRS2018_data, HRS2018_data$reason_discrim1_reason_disability == 1)



HRS2018_data_disability_discrim = na.omit(HRS2018_data_disability_discrim)
HRS2016_data_disability_discrim = na.omit(HRS2016_data_disability_discrim)
HRS2014_data_disability_discrim = na.omit(HRS2014_data_disability_discrim)
HRS2012_data_disability_discrim = na.omit(HRS2012_data_disability_discrim)
HRS2010_data_disability_discrim = na.omit(HRS2010_data_disability_discrim)
HRS2008_data_disability_discrim = na.omit(HRS2008_data_disability_discrim)




WCE_dataset_disability_discrim = rbind(HRS2008_data_disability_discrim,
                         HRS2010_data_disability_discrim,
                         HRS2012_data_disability_discrim,
                         HRS2014_data_disability_discrim,
                         HRS2016_data_disability_discrim, 
                         HRS2018_data_disability_discrim)


WCE_dataset_disability_discrim$diabetes_new_bin = case_when(WCE_dataset_disability_discrim$diabetes_new ==0 ~ 0, 
...
WCE_dataset_disability_discrim = subset(WCE_dataset_disability_discrim , summary_mean_score_discrim != " NA")
unique(WCE_dataset_disability_discrim$summary_mean_score_discrim)

WCE_dataset_disability_discrim = subset(WCE_dataset_disability_discrim , discrim_harassed != " NA")
unique(WCE_dataset_disability_discrim$discrim_harassed)


WCE_dataset_disability_discrim = subset(WCE_dataset_disability_discrim , discrim_lessrespect != " NA")
unique(WCE_dataset_disability_discrim$discrim_lessrespect)

WCE_dataset_disability_discrim = subset(WCE_dataset_disability_discrim , discrim_medical != " NA")
unique(WCE_dataset_disability_discrim$discrim_medical)

WCE_dataset_disability_discrim = subset(WCE_dataset_disability_discrim , discrim_notclever != " NA")
unique(WCE_dataset_disability_discrim$discrim_notclever)

WCE_dataset_disability_discrim = subset(WCE_dataset_disability_discrim , discrim_poorerservice != " NA")
