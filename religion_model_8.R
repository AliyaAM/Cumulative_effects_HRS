...
religion_discrim_harassed_bin_model_8_stats_recoded = religion_discrim_harassed_bin_age[2]
...
write.csv(religion_discrim_harassed_bin_model_8_stats_recoded, paste(OUTPUT_ROOT, "stats/religion_overal_discrim_model_8_stats_recoded.csv", sep=""))
...
religion_discrim_lessrespect_bin_model_8_stats_recoded = religion_discrim_lessrespect_bin_age[2]
...
write.csv(religion_discrim_lessrespect_bin_model_8_stats_recoded, paste(OUTPUT_ROOT, "stats/religion_discrim_lessrespect_bin_model_8_stats_recoded.csv", sep=""))
...
religion_discrim_medical_bin_model_8_stats_recoded = religion_discrim_medical_bin_age[2]
...
write.csv(religion_discrim_medical_bin_model_8_stats_recoded, paste(OUTPUT_ROOT, "stats/religion_discrim_medical_bin_model_8_stats_recoded.csv", sep=""))
...
religion_discrim_notclever_bin_model_8_stats_recoded = religion_discrim_notclever_bin_age[2]
...
write.csv(religion_discrim_notclever_bin_model_8_stats_recoded, paste(OUTPUT_ROOT, "stats/religion_discrim_notclever_bin_model_8_stats_recoded.csv", sep=""))
...
religion_discrim_poorerservice_bin_model_8_stats_recoded = religion_discrim_poorerservice_bin_age[2]
...
write.csv(religion_discrim_poorerservice_bin_model_8_stats_recoded, paste(OUTPUT_ROOT, "stats/religion_discrim_poorerservice_bin_model_8_stats_recoded.csv", sep=""))
...
religion_afraid_others_model_8_stats_recoded = religion_afraid_others_age[2]
...
write.csv(religion_afraid_others_model_8_stats_recoded, paste(OUTPUT_ROOT, "stats/religion_afraid_others_model_8_stats_recoded.csv", sep=""))
...
write.csv(religion_all_results, paste(OUTPUT_ROOT, "religion_all_results_bin_model_8_test.csv", sep=""))
