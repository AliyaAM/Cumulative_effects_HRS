...
source((paste(SOURCE_ROOT, "subset_sort_version_3.R", sep="")))
...
national_race_religion_dataset = subset_sort_version_3(subset_var1 = "race_white", 
                                              subset_value1 = 0,
                                              subset_var2 = "national_origin_ousideUS_bin", 
                                              subset_value2 = 1,
                                              subset_var3 = "religion_bin", 
                                               subset_value3 = 1)
#self-reported
...
national_origin_Model_1_discrim_bin = discrim_bin_model_func(data_wce_subset = national_race_religion_dataset, 
                                                             Model_n = Model_1, 
                                                             Model_name = "Model_1")


national_origin_Model_2_discrim_bin = discrim_bin_model_func(data_wce_subset = national_race_religion_dataset, 
                                                             Model_n = Model_2, 
                                                             Model_name = "Model_2")


national_origin_Model_3_discrim_bin = discrim_bin_model_func(data_wce_subset = national_race_religion_dataset, 
                                                             Model_n = Model_3)



national_origin_Model_4_discrim_bin = discrim_bin_model_func(data_wce_subset = national_race_religion_dataset, 
                                                             Model_n = Model_4)



national_origin_Model_5_discrim_bin = discrim_bin_model_func(data_wce_subset = national_race_religion_dataset, 
                                                             Model_n = Model_5)


national_origin_Model_6_discrim_bin = discrim_bin_model_func(data_wce_subset = national_race_religion_dataset, 
                                                             Model_n = Model_6)


national_origin_Model_7_discrim_bin = discrim_bin_model_func(data_wce_subset = national_race_religion_dataset, 
                                                             Model_n = Model_7)



national_origin_Model_8_discrim_bin = discrim_bin_model_func(data_wce_subset = national_race_religion_dataset, 
                                                             Model_n = Model_8)


national_origin_Model_9_discrim_bin = discrim_bin_model_func(data_wce_subset = national_race_religion_dataset, 
                                                             Model_n = Model_9)


national_origin_Model_10_discrim_bin = discrim_bin_model_func(data_wce_subset = national_race_religion_dataset, 
                                                              Model_n = Model_10)


national_origin_Model_11_discrim_bin = discrim_bin_model_func(data_wce_subset = national_race_religion_dataset, 
                                                              Model_n = Model_11)
...
national_origin_Model_12_discrim_bin = discrim_bin_model_func(data_wce_subset = national_race_religion_dataset, 
                                                              Model_n = Model_12)
...
national_origin_Model_13_discrim_bin = discrim_bin_model_func(data_wce_subset = national_race_religion_dataset, 
                                                              Model_n = Model_13)


national_origin_Model_14_discrim_bin = discrim_bin_model_func(data_wce_subset = national_race_religion_dataset, 
                                                              Model_n = Model_14)

national_origin_Model_15_discrim_bin = discrim_bin_model_func(data_wce_subset = national_race_religion_dataset, 
                                                              Model_n = Model_15)

national_origin_Model_16_discrim_bin = discrim_bin_model_func(data_wce_subset = national_race_religion_dataset, 
                                                              Model_n = Model_16)


national_origin_Model_17_discrim_bin = discrim_bin_model_func(data_wce_subset = national_race_religion_dataset, 
                                                              Model_n = Model_17)
...
national_AND_race_AND_religion_results_discrim_bin = rbind(national_origin_Model_1_discrim_bin,
...
write.csv(national_AND_race_AND_religion_results_discrim_bin, paste(OUTPUT_ROOT, "national_AND_race_AND_religion_results_discrim_bin.csv", sep=""))


national_AND_race_AND_religion_results_discrim_bin_table_col = cbind(national_origin_Model_1_discrim_bin,
                                                        national_origin_Model_2_discrim_bin,
                                                        national_origin_Model_3_discrim_bin,
                                                        national_origin_Model_4_discrim_bin,
                                                        national_origin_Model_5_discrim_bin,
...
write.csv(national_AND_race_AND_religion_results_discrim_bin_table_col, paste(OUTPUT_ROOT, "national_AND_race_AND_religion_results_discrim_bin_table_col.csv", sep=""))
