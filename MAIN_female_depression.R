...
WCE_dataset_female = read.csv(paste(SOURCE_data_ROOT, "WCE_dataset_female_depression.csv", sep=""))
...
######## main analysis producing HR for developing depression as aresult of cumulative effects of discriminaiton over years 2008 - 2018
...
write.csv(female_overal_discrim_stats, paste(OUTPUT_ROOT, "stats/female_overal_discrim_stats_depression.csv", sep=""))
...
write.csv(female_discrim_harassed_stats, paste(OUTPUT_ROOT, "stats/female_discrim_harassed_age_stats_depression.csv", sep=""))
...
write.csv(female_discrim_lessrespect_stats, paste(OUTPUT_ROOT, "stats/female_discrim_lessrespect_age_stats_depression.csv", sep=""))
...
write.csv(female_discrim_medical_stats, paste(OUTPUT_ROOT, "stats/female_discrim_medical_stats_depression.csv", sep=""))
...
write.csv(female_discrim_notclever_stats, paste(OUTPUT_ROOT, "stats/female_discrim_notclever_stats_depression.csv", sep=""))
...
write.csv(female_discrim_poorerservice_stats, paste(OUTPUT_ROOT, "stats/female_discrim_poorerservice_stats_depression.csv", sep=""))
...
write.csv(female_afraid_others_age_stats, paste(OUTPUT_ROOT, "stats/female_afraid_others_age_stats_depression.csv", sep=""))
...
write.csv(female_all_results, paste(OUTPUT_ROOT, "female_all_results_depression.csv", sep=""))
