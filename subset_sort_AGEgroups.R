...
subset_sort_AGEgroups = function (subset_var1, subset_value1, subset_var2, subset_value2){
  ...
  WCE_dataset_subset = WCE_dataset_subset %>% drop_na(reason_discrim1_reason_age)  
