...
age50_60yrs_dataset$reason_discrim1_reason_national
age50_60yrs_dataset$reason_discrim1_reason_race
...
female_dataset = subset_sort_version_2(subset_var1 = "sex_1_2", 
                                       subset_value1 = 2,
                                       subset_var2 = "reason_discrim1_reason_gender", 
                                       subset_value2 = 1) 

#self-reported
national_origin_dataset = subset_sort(subset_var1 = "national_origin_ousideUS_bin", 
                                      subset_value1 = 1,
                                      subset_var2 = "reason_discrim1_reason_national", 
                                      subset_value2 = 1) 

#self-reported
race_dataset = subset_sort(subset_var1 = "race_white", 
                           subset_value1 = 0,
                           subset_var2 = "reason_discrim1_reason_race", 
                           subset_value2 = 1) 

#self-reported
religion_dataset = subset_sort(subset_var1 = "religion_bin", 
                               subset_value1 = 1,
                               subset_var2 = "reason_discrim1_reason_religion", 
                               subset_value2 = 1) 

#objectively measured weight and height from which the BMi was calculated
BMI_dataset = subset_sort_BMI(subset_var1 = "assessed_BMI", 
                              subset_value1 = 30,
                              subset_var2 = "reason_discrim1_reason_weight", 
                              subset_value2 = 1) 
...
write.csv(female_results_discrim_bin, paste(OUTPUT_ROOT, "female_results_discrim_binrestricted_reason.csv", sep=""))
...
write.csv(female_results_discrim_bin_table_col, paste(OUTPUT_ROOT, "female_results_discrim_bin_table_colrestricted_reason.csv", sep=""))
...
write.csv(national_origin_results_discrim_bin, paste(OUTPUT_ROOT, "national_origin_results_discrim_binrestricted_reason.csv", sep=""))
...
write.csv(national_origin_results_discrim_bin_table_col, paste(OUTPUT_ROOT, "national_origin_results_discrim_bin_table_colrestricted_reason.csv", sep=""))
...
write.csv(race_results_discrim_bin, paste(OUTPUT_ROOT, "race_results_discrim_binrestricted_reason.csv", sep=""))
...
write.csv(race_results_discrim_bin_table_col, paste(OUTPUT_ROOT, "race_results_discrim_bin_table_colrestricted_reason.csv", sep=""))
...
write.csv(religion_results_discrim_bin, paste(OUTPUT_ROOT, "religion_results_discrim_binrestricted_reason.csv", sep=""))
...
write.csv(religion_results_discrim_bin_table_col, paste(OUTPUT_ROOT, "religion_results_discrim_bin_table_colrestricted_reason.csv", sep=""))
...
write.csv(BMI_results_discrim_bin, paste(OUTPUT_ROOT, "BMI_results_discrim_binrestricted_reason.csv", sep=""))
...
write.csv(BMI_results_discrim_bin_table_col, paste(OUTPUT_ROOT, "BMI_results_discrim_bin_table_colrestricted_reason.csv", sep=""))
#############
...
write.csv(BMI_results_discrim_bin_noBMIcov, paste(OUTPUT_ROOT, "BMI_results_discrim_bin_noBMIcovrestricted_reason.csv", sep=""))
...
write.csv(BMI_results_discrim_bin_noBMIcov_table_col, paste(OUTPUT_ROOT, "BMI_results_discrim_bin_noBMIcov_table_colrestricted_reason.csv", sep=""))