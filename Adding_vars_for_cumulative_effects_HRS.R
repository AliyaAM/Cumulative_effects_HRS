...
harmonised_data_all_waves = read.csv(paste(SOURCE_ROOT, "Harmonised_data_all_waves_HRS/H_HRS_c.csv", sep=""))


2. organise by PN, ID, (match)

3. add covariates below: BMI from harmonised data 
...
HRS2010_data$wealth_noIRA_HRS2010
#2012: H11ATOTW
HRS2012_data$wealth_noIRA_HRS2012 = HRS2012_data_RAND$H11ATOTW

#2014: H12ATOTW
HRS2014_data$wealth_noIRA_HRS2014 = HRS2014_data_RAND$H11ATOTW
...
HRS2012_data$sex_1_2 = HRS2012_data_RAND$GENDER

HRS2014_data$sex_1_2 = HRS2014_data_RAND$GENDER
HRS2016_data$sex_1_2 = HRS2016_data_RAND$GENDER
HRS2018_data$sex_1_2 = HRS2018_data_RAND$GENDER
...
HRS2008_data$limiting_condition = HRS2008_data_RAND$LM007
HRS2008_data$limiting_condition_bin = case_when(HRS2008_data_RAND$LM007 == " 1" ~ 1, 
...
unique(HRS2012_data$limiting_condition)

HRS2012_data$limiting_condition_bin = case_when(HRS2012_data_RAND$NM007 == 1 ~ 1, 
                                                HRS2012_data_RAND$NM007 == 5 ~ 0)

#2014:  harmonised data:R12LIMIMPAR
HRS2014_data$limiting_condition_bin = case_when(HRS2014_data_RAND$OM007 == 1 ~ 1, 
...
HRS2018_data$limiting_condition_bin = case_when(HRS2018_data_RAND$M007 == 1 ~ 1, 
...
#BMI: 2008, wave 9: 
#BMI categories: 
harmonised_data_all_waves$r9bmicat
harmonised_data_all_waves$r9mbmi


#BMI: 2010, wave 10: 
harmonised_data_all_waves$r10bmicat
harmonised_data_all_waves$r10mbmi


#BMI: 2012, wave 11: 
harmonised_data_all_waves$r11bmicat 
harmonised_data_all_waves$r11mbmi
