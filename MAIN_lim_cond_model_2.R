...
lim_cond_discrim_harassed_bin_model2_stats_recoded = lim_cond_discrim_harassed_bin_age[2]
...
write.csv(lim_cond_discrim_harassed_bin_model2_stats_recoded, paste(OUTPUT_ROOT, "stats/lim_cond_overal_discrim_model2_stats_recoded.csv", sep=""))
...
lim_cond_discrim_lessrespect_bin_model2_stats_recoded = lim_cond_discrim_lessrespect_bin_age[2]
...
write.csv(lim_cond_discrim_lessrespect_bin_model2_stats_recoded, paste(OUTPUT_ROOT, "stats/lim_cond_discrim_lessrespect_bin_model2_stats_recoded.csv", sep=""))
...
lim_cond_discrim_medical_bin_model2_stats_recoded = lim_cond_discrim_medical_bin_age[2]
...
write.csv(lim_cond_discrim_medical_bin_model2_stats_recoded, paste(OUTPUT_ROOT, "stats/lim_cond_discrim_medical_bin_model2_stats_recoded.csv", sep=""))
...
lim_cond_discrim_notclever_bin_model2_stats_recoded = lim_cond_discrim_notclever_bin_age[2]
...
write.csv(lim_cond_discrim_notclever_bin_model2_stats_recoded, paste(OUTPUT_ROOT, "stats/lim_cond_discrim_notclever_bin_model2_stats_recoded.csv", sep=""))
...
lim_cond_discrim_poorerservice_bin_model2_stats_recoded = lim_cond_discrim_poorerservice_bin_age[2]
...
write.csv(lim_cond_discrim_poorerservice_bin_model2_stats_recoded, paste(OUTPUT_ROOT, "stats/lim_cond_discrim_poorerservice_bin_model2_stats_recoded.csv", sep=""))
...
lim_cond_afraid_others_model2_stats_recoded = lim_cond_afraid_others_age[2]
...
write.csv(lim_cond_afraid_others_model2_stats_recoded, paste(OUTPUT_ROOT, "stats/lim_cond_afraid_others_model2_stats_recoded.csv", sep=""))
...
write.csv(lim_cond_all_results, paste(OUTPUT_ROOT, "lim_cond_all_results_bin_model2.csv", sep=""))
