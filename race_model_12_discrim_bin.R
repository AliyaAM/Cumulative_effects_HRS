...
race_discrim_bin_Model_12 = summary_score_WCE_analysis(data_WCE = data_wce_race,
                                                       exposure = "discrim_bin", 
                                                       outcome = "diabetes_new_bin", 
                                                       covariates_list = Model_12)


race_discrim_bin_HR_Model_12 = race_discrim_bin_Model_12[1]

race_discrim_bin_Model_12_stats_recoded = race_discrim_bin_Model_12[2]
...
race_discrim_bin_age_CI_Model_12  = summary_score_Bootstrapped_CI(WCE_data_CI = data_wce_race,
                                                                  exposure = "discrim_bin", 
                                                                  outcome = "diabetes_new_bin",
                                                                  covariates_list = Model_12)


write.csv(race_discrim_bin_Model_12_stats_recoded, paste(OUTPUT_ROOT, "stats/race_discrim_BIN_Model_12_stats.csv", sep=""))


race_discrim_bin_HR_Model_12 = unlist(race_discrim_bin_HR_Model_12)
race_discrim_bin_results_Model_12 = cbind(race_discrim_bin_HR_Model_12, race_discrim_bin_age_CI_Model_12)

colnames(race_discrim_bin_results_Model_12) = c("hazard ratio", "5% CI", "95% CI")



write.csv(race_discrim_bin_results_Model_12, paste(OUTPUT_ROOT, "race_discrim_BIN_results_Model_12.csv", sep=""))
