...
#WCE_dataset_religion = read.csv(paste(SOURCE_data_ROOT, "WCE_dataset_religion_diabetes.csv", sep=""))
#unique(WCE_dataset_religion$diabetes_new_bin)
#WCE_dataset_religion$discrim_harassed_bin
...
#unique(WCE_dataset_religion$summary_mean_score_discrim_bin)
#unique(WCE_dataset_religion$discrim_harassed_bin)
#unique(WCE_dataset_religion$discrim_lessrespect_bin)
#unique(WCE_dataset_religion$discrim_medical_bin)
#unique(WCE_dataset_religion$discrim_notclever_bin)
#unique(WCE_dataset_religion$discrim_poorerservice_bin)
#unique(WCE_dataset_religion$discrim_afraidothers_bin)
...
#################################### ######## ########################################################################
# Model 1: age
# Model 2: age and religion 
# Model 3: age, religion, wealth,  (1)
# Model 4: age, religion, hypertension  (2)
# Model 5: age, religion, hypertension, wealth 
# Model 6: smoking, physical activity, alcohol consumption
# Model 7: age, religion,  smoking, physical activity, alcohol consumption  (3)
# Model 8:age, religion, smoking, physical activity, alcohol consumption, hypertension
# Model 9: age, religion, CVD  (4)
# Model 10: age, religion,CVD, hypertension 
# Model 11: age, religion, smoking, physical activity, alcohol consumption, CVD  
# Model 12: age, religion, smoking, physical activity, alcohol consumption, CVD, hypertension  (5)
# Model 13: age, religion, depression  (6)
# Model 14: age, religion, smoking, physical activity, alcohol consumption, depression (7)
# Model 15: age, religion, hypertension, depression 
# Model 16: age, religion,CVD, hypertension, depression 
# Model 17: age, religion, smoking, physical activity, alcohol consumption, CVD, hypertension, depression  (8)
#######
#age, sex, wealth, ethnicity, smoking, physical activity, alcohol consumption, religion, hypertension, CVD
...
#################################### religion ########################################################################
# # # # subset the data set to those with religion
...
WCE_dataset_religion = rbind(HRS2008_data_religion,
                             HRS2010_data_religion, 
                             HRS2012_data_religion,
                             HRS2014_data_religion, 
                             HRS2016_data_religion,
                             HRS2018_data_religion)
...
WCE_dataset_religion$CVD[WCE_dataset_religion$heartcondition_ever_bin == 1 | WCE_dataset_religion$heartcondition_new_bin == 1 | WCE_dataset_religion$angina_new_bin ==1 | WCE_dataset_religion$stroke_new_bin == 1 | WCE_dataset_religion$heartfailure2yrs_bin == 1 | WCE_dataset_religion$heartattack_ever_bin == 1 | WCE_dataset_religion$heartattack_new_bin == 1] <-1
WCE_dataset_religion$CVD[WCE_dataset_religion$heartcondition_ever_bin == 0 & WCE_dataset_religion$heartcondition_new_bin == 0 & WCE_dataset_religion$angina_new_bin ==0 & WCE_dataset_religion$stroke_new_bin == 0 & WCE_dataset_religion$heartfailure2yrs_bin == 0 & WCE_dataset_religion$heartattack_ever_bin == 0 & WCE_dataset_religion$heartattack_new_bin == 0] <-0

###### add binary esposure and binary outcome 


WCE_dataset_religion$diabetes_new_bin = case_when(WCE_dataset_religion$diabetes_new == 1 ~ 1, 
                                                  WCE_dataset_religion$diabetes_new == 0 ~ 0, 
                                                  WCE_dataset_religion$diabetes_new == 3 ~ 1, 
                                                  WCE_dataset_religion$diabetes_new == 4 ~ 0) 



#physical activity (original): 1.every day; 2.>1 per week; 3.1 per week; 4.l-3 per mon; 5.never; .d=DK/NA; .r=RF

WCE_dataset_religion$vigarious_physical_activity_new = case_when(WCE_dataset_religion$vigarious_physical_activity == 1 ~ 5, 
                                                                 WCE_dataset_religion$vigarious_physical_activity == 2 ~ 4, 
                                                                 WCE_dataset_religion$vigarious_physical_activity == 3 ~ 3, 
                                                                 WCE_dataset_religion$vigarious_physical_activity == 4 ~ 2, 
                                                                 WCE_dataset_religion$vigarious_physical_activity == 5 ~ 1) 



WCE_dataset_religion$vigarious_physical_activity_bin = case_when(WCE_dataset_religion$vigarious_physical_activity_new == 5 ~ 1, 
                                                                 WCE_dataset_religion$vigarious_physical_activity_new == 4 ~ 1, 
                                                                 WCE_dataset_religion$vigarious_physical_activity_new == 3 ~ 1, 
                                                                 WCE_dataset_religion$vigarious_physical_activity_new == 2 ~ 0, 
                                                                 WCE_dataset_religion$vigarious_physical_activity_new == 1 ~ 0) 

unique(WCE_dataset_religion$alcohol_days_week)


WCE_dataset_religion$alcohol_days_week_new =  na_if(WCE_dataset_religion$alcohol_days_week, 8)
WCE_dataset_religion$alcohol_days_week_new = na_if(WCE_dataset_religion$alcohol_days_week_new, 9) 

unique(WCE_dataset_religion$alcohol_days_week_new)
...
WCE_dataset_religion = WCE_dataset_religion %>% drop_na(discrim_harassed_bin)
...
WCE_dataset_religion = subset(WCE_dataset_religion , diabetes_new_bin != " NA")
unique(WCE_dataset_religion$diabetes_new)
...
WCE_dataset_religion$alcohol_days_week_new = as.numeric(WCE_dataset_religion$alcohol_days_week_new)
WCE_dataset_religion$vigarious_physical_activity_new = as.numeric(WCE_dataset_religion$vigarious_physical_activity_new)
WCE_dataset_religion$smokes_now_bin = as.numeric(WCE_dataset_religion$smokes_now_bin)
...
unique(data_wce_religion$hypertension_new_bin)
...
religion_discrim_harassed_bin_model_10_stats_recoded = religion_discrim_harassed_bin_age[2]
...
write.csv(religion_discrim_harassed_bin_model_10_stats_recoded, paste(OUTPUT_ROOT, "stats/religion_overal_discrim_model_10_stats_recoded.csv", sep=""))
...
religion_discrim_lessrespect_bin_model_10_stats_recoded = religion_discrim_lessrespect_bin_age[2]
...
write.csv(religion_discrim_lessrespect_bin_model_10_stats_recoded, paste(OUTPUT_ROOT, "stats/religion_discrim_lessrespect_bin_model_10_stats_recoded.csv", sep=""))
...
religion_discrim_medical_bin_model_10_stats_recoded = religion_discrim_medical_bin_age[2]
...
write.csv(religion_discrim_medical_bin_model_10_stats_recoded, paste(OUTPUT_ROOT, "stats/religion_discrim_medical_bin_model_10_stats_recoded.csv", sep=""))
...
religion_discrim_notclever_bin_model_10_stats_recoded = religion_discrim_notclever_bin_age[2]
...
write.csv(religion_discrim_notclever_bin_model_10_stats_recoded, paste(OUTPUT_ROOT, "stats/religion_discrim_notclever_bin_model_10_stats_recoded.csv", sep=""))
...
religion_discrim_poorerservice_bin_model_10_stats_recoded = religion_discrim_poorerservice_bin_age[2]
...
write.csv(religion_discrim_poorerservice_bin_model_10_stats_recoded, paste(OUTPUT_ROOT, "stats/religion_discrim_poorerservice_bin_model_10_stats_recoded.csv", sep=""))
...
religion_afraid_others_model_10_stats_recoded = religion_afraid_others_age[2]
...
write.csv(religion_afraid_others_model_10_stats_recoded, paste(OUTPUT_ROOT, "stats/religion_afraid_others_model_10_stats_recoded.csv", sep=""))
...
write.csv(religion_all_results, paste(OUTPUT_ROOT, "religion_all_results_bin_model_10_test.csv", sep=""))
