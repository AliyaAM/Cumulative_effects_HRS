...
race_discrim_bin_Model_9 = summary_score_WCE_analysis(data_WCE = data_wce_race,
                                                      exposure = "discrim_bin", 
                                                      outcome = "diabetes_new_bin", 
                                                      covariates_list = Model_9)


race_discrim_bin_HR_Model_9 = race_discrim_bin_Model_9[1]

race_discrim_bin_Model_9_stats_recoded = race_discrim_bin_Model_9[2]
...
race_discrim_bin_age_CI_Model_9  = summary_score_Bootstrapped_CI(WCE_data_CI = data_wce_race,
                                                                 exposure = "discrim_bin", 
                                                                 outcome = "diabetes_new_bin",
                                                                 covariates_list = Model_9)


write.csv(race_discrim_bin_Model_9_stats_recoded, paste(OUTPUT_ROOT, "stats/race_discrim_BIN_Model_9_stats.csv", sep=""))


race_discrim_bin_HR_Model_9 = unlist(race_discrim_bin_HR_Model_9)
race_discrim_bin_results_Model_9 = cbind(race_discrim_bin_HR_Model_9, race_discrim_bin_age_CI_Model_9)

colnames(race_discrim_bin_results_Model_9) = c("hazard ratio", "5% CI", "95% CI")



write.csv(race_discrim_bin_results_Model_9, paste(OUTPUT_ROOT, "race_discrim_BIN_results_Model_9.csv", sep=""))
