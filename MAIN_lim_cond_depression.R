...
WCE_dataset_lim_cond = read.csv(paste(SOURCE_data_ROOT, "WCE_dataset_lim_cond_depression_bin.csv", sep=""))
...
write.csv(lim_cond_overal_discrim_stats, paste(OUTPUT_ROOT, "stats/lim_cond_overal_discrim_stats_checklist_depression_bin.csv", sep=""))
...
write.csv(lim_cond_discrim_harassed_stats, paste(OUTPUT_ROOT, "stats/lim_cond_discrim_harassed_age_stats_checklist_depression_bin.csv", sep=""))
...
write.csv(lim_cond_discrim_lessrespect_stats, paste(OUTPUT_ROOT, "stats/lim_cond_discrim_lessrespect_age_stats_checklist_depression_bin.csv", sep=""))
...
write.csv(lim_cond_discrim_medical_stats, paste(OUTPUT_ROOT, "stats/lim_cond_discrim_medical_stats_checklist_depression_bin.csv", sep=""))
...
write.csv(lim_cond_discrim_notclever_stats, paste(OUTPUT_ROOT, "stats/lim_cond_discrim_notclever_stats_checklist_depression_bin.csv", sep=""))
...
write.csv(lim_cond_discrim_poorerservice_stats, paste(OUTPUT_ROOT, "stats/lim_cond_discrim_poorerservice_stats_checklist_depression_bin.csv", sep=""))
...
write.csv(lim_cond_afraid_others_age_stats, paste(OUTPUT_ROOT, "stats/lim_cond_afraid_others_age_stats_checklist_depression_bin.csv", sep=""))
...
write.csv(lim_cond_all_results, paste(OUTPUT_ROOT, "lim_cond_all_results_depression_bin.csv", sep=""))
