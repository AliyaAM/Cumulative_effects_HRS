...
write.csv(religion_afraid_others_age_stats, paste(OUTPUT_ROOT, "religion_afraid_others_age_stats.csv", sep=""))
...
write.csv(religion_all_results, paste(OUTPUT_ROOT, "religion_all_results.csv", sep=""))
