...
BMI_discrim_harassed_bin_model_9_stats_recoded = BMI_discrim_harassed_bin_age[2]
...
write.csv(BMI_discrim_harassed_bin_model_9_stats_recoded, paste(OUTPUT_ROOT, "stats/BMI_overal_discrim_model_9_stats_recoded.csv", sep=""))
...
BMI_discrim_lessrespect_bin_model_9_stats_recoded = BMI_discrim_lessrespect_bin_age[2]
...
write.csv(BMI_discrim_lessrespect_bin_model_9_stats_recoded, paste(OUTPUT_ROOT, "stats/BMI_discrim_lessrespect_bin_model_9_stats_recoded.csv", sep=""))
...
BMI_discrim_medical_bin_model_9_stats_recoded = BMI_discrim_medical_bin_age[2]
...
write.csv(BMI_discrim_medical_bin_model_9_stats_recoded, paste(OUTPUT_ROOT, "stats/BMI_discrim_medical_bin_model_9_stats_recoded.csv", sep=""))
...
BMI_discrim_notclever_bin_model_9_stats_recoded = BMI_discrim_notclever_bin_age[2]
...
write.csv(BMI_discrim_notclever_bin_model_9_stats_recoded, paste(OUTPUT_ROOT, "stats/BMI_discrim_notclever_bin_model_9_stats_recoded.csv", sep=""))
...
BMI_discrim_poorerservice_bin_model_9_stats_recoded = BMI_discrim_poorerservice_bin_age[2]
...
write.csv(BMI_discrim_poorerservice_bin_model_9_stats_recoded, paste(OUTPUT_ROOT, "stats/BMI_discrim_poorerservice_bin_model_9_stats_recoded.csv", sep=""))
...
BMI_afraid_others_model_9_stats_recoded = BMI_afraid_others_age[2]
...
write.csv(BMI_afraid_others_model_9_stats_recoded, paste(OUTPUT_ROOT, "stats/BMI_afraid_others_model_9_stats_recoded.csv", sep=""))
...
write.csv(BMI_all_results, paste(OUTPUT_ROOT, "BMI_all_results_bin_model_9_test.csv", sep=""))
