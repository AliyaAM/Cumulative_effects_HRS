...
unique(WCE_dataset_national_origin_ousideUS$discrim_poorerservice)
unique(WCE_dataset_national_origin_ousideUS$discrim_afraidothers)
unique(WCE_dataset_national_origin_ousideUS$wealth_noIRA)
...
WCE_dataset_national_origin_ousideUS$discrim_harassed = as.numeric(WCE_dataset_national_origin_ousideUS$discrim_harassed)
WCE_dataset_national_origin_ousideUS$discrim_lessrespect = as.numeric(WCE_dataset_national_origin_ousideUS$discrim_lessrespect)
WCE_dataset_national_origin_ousideUS$discrim_medical = as.numeric(WCE_dataset_national_origin_ousideUS$discrim_medical)
WCE_dataset_national_origin_ousideUS$discrim_notclever = as.numeric(WCE_dataset_national_origin_ousideUS$discrim_notclever)
WCE_dataset_national_origin_ousideUS$discrim_poorerservice = as.numeric(WCE_dataset_national_origin_ousideUS$discrim_poorerservice)
WCE_dataset_national_origin_ousideUS$discrim_afraidothers = as.numeric(WCE_dataset_national_origin_ousideUS$discrim_afraidothers)

WCE_dataset_national_origin_ousideUS$wealth_noIRA = as.numeric(WCE_dataset_national_origin_ousideUS$wealth_noIRA)
WCE_dataset_national_origin_ousideUS$assessed_BMI = as.numeric(WCE_dataset_national_origin_ousideUS$assessed_BMI)
