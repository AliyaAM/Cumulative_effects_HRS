...
HRS2008_data_national_origin_ousideUS = data_frame(HRS2008_data_national_origin_ousideUS$HHIDPN,
                                                   HRS2008_data_national_origin_ousideUS$diabetes_new,
                                                   HRS2008_data_national_origin_ousideUS$diabetes_ever,
                                                   HRS2008_data_national_origin_ousideUS$sex_1_2,
                                                   HRS2008_data_national_origin_ousideUS$wealth_noIRA,
                                                   HRS2008_data_national_origin_ousideUS$start,
                                                   HRS2008_data_national_origin_ousideUS$stop,
                                                   HRS2008_data_national_origin_ousideUS$reason_discrim1_reason_disability,
                                                   
                                                   HRS2008_data_national_origin_ousideUS$discrim_harassed,
                                                   HRS2008_data_national_origin_ousideUS$discrim_lessrespect,
                                                   HRS2008_data_national_origin_ousideUS$discrim_medical,
                                                   HRS2008_data_national_origin_ousideUS$discrim_notclever,
                                                   HRS2008_data_national_origin_ousideUS$discrim_poorerservice,
                                                   HRS2008_data_national_origin_ousideUS$discrim_afraidothers,
                                                   
                                                   HRS2008_data_national_origin_ousideUS$continious_age,
                                                   HRS2008_data_national_origin_ousideUS$assessed_BMI)

nrow_2008 = nrow(HRS2008_data_national_origin_ousideUS) 
HRS2008_data_national_origin_ousideUS$year_2008 = rep(2010, times = nrow_2008)

HRS2008_data_national_origin_ousideUS <- na.omit(HRS2008_data_national_origin_ousideUS)


HRS2010_data_national_origin_ousideUS = data_frame(HRS2010_data_national_origin_ousideUS$HHIDPN,
                                                   HRS2010_data_national_origin_ousideUS$diabetes_new,
                                                   HRS2010_data_national_origin_ousideUS$diabetes_ever,
                                                   HRS2010_data_national_origin_ousideUS$sex_1_2,
                                                   HRS2010_data_national_origin_ousideUS$wealth_noIRA,
                                                   HRS2010_data_national_origin_ousideUS$start,
                                                   HRS2010_data_national_origin_ousideUS$stop,
                                                   HRS2010_data_national_origin_ousideUS$reason_discrim1_reason_disability,
                                                   
                                                   HRS2010_data_national_origin_ousideUS$discrim_harassed,
                                                   HRS2010_data_national_origin_ousideUS$discrim_lessrespect,
                                                   HRS2010_data_national_origin_ousideUS$discrim_medical,
                                                   HRS2010_data_national_origin_ousideUS$discrim_notclever,
                                                   HRS2010_data_national_origin_ousideUS$discrim_poorerservice,
                                                   
                                                   HRS2010_data_national_origin_ousideUS$discrim_afraidothers,
                                                   HRS2010_data_national_origin_ousideUS$continious_age,
                                                   HRS2010_data_national_origin_ousideUS$assessed_BMI)

nrow_2010 = nrow(HRS2010_data_national_origin_ousideUS) 
HRS2010_data_national_origin_ousideUS$year_2010 = rep(2010, times = nrow_2010)

HRS2010_data_national_origin_ousideUS <- na.omit(HRS2010_data_national_origin_ousideUS)

HRS2012_data_national_origin_ousideUS = data_frame(HRS2012_data_national_origin_ousideUS$HHIDPN,
                                                   HRS2012_data_national_origin_ousideUS$diabetes_new,
                                                   HRS2012_data_national_origin_ousideUS$diabetes_ever,
                                                   HRS2012_data_national_origin_ousideUS$sex_1_2,
                                                   HRS2012_data_national_origin_ousideUS$wealth_noIRA,
                                                   HRS2012_data_national_origin_ousideUS$start,
                                                   HRS2012_data_national_origin_ousideUS$stop,
                                                   HRS2012_data_national_origin_ousideUS$reason_discrim1_reason_disability,
                                                   
                                                   HRS2012_data_national_origin_ousideUS$discrim_harassed,
                                                   HRS2012_data_national_origin_ousideUS$discrim_lessrespect,
                                                   HRS2012_data_national_origin_ousideUS$discrim_medical,
                                                   HRS2012_data_national_origin_ousideUS$discrim_notclever,
                                                   HRS2012_data_national_origin_ousideUS$discrim_poorerservice,
                                                   HRS2012_data_national_origin_ousideUS$discrim_afraidothers,
                                                   
                                                   HRS2012_data_national_origin_ousideUS$continious_age,
                                                   HRS2012_data_national_origin_ousideUS$assessed_BMI)


nrow_2012 = nrow(HRS2012_data_national_origin_ousideUS) 
HRS2012_data_national_origin_ousideUS$year_2012 = rep(2012, times = nrow_2012)

HRS2012_data_national_origin_ousideUS <- na.omit(HRS2012_data_national_origin_ousideUS)


HRS2014_data_national_origin_ousideUS = data_frame(HRS2014_data_national_origin_ousideUS$HHIDPN,
                                                   HRS2014_data_national_origin_ousideUS$diabetes_new,
                                                   HRS2014_data_national_origin_ousideUS$diabetes_ever,
                                                   HRS2014_data_national_origin_ousideUS$sex_1_2,
                                                   HRS2014_data_national_origin_ousideUS$wealth_noIRA,
                                                   HRS2014_data_national_origin_ousideUS$start,
                                                   HRS2014_data_national_origin_ousideUS$stop,
                                                   HRS2014_data_national_origin_ousideUS$reason_discrim1_reason_disability,
                                                   
                                                   HRS2014_data_national_origin_ousideUS$discrim_harassed,
                                                   HRS2014_data_national_origin_ousideUS$discrim_lessrespect,
                                                   HRS2014_data_national_origin_ousideUS$discrim_medical,
                                                   HRS2014_data_national_origin_ousideUS$discrim_notclever,
                                                   HRS2014_data_national_origin_ousideUS$discrim_poorerservice,
                                                   HRS2014_data_national_origin_ousideUS$discrim_afraidothers,
                                                   
                                                   HRS2014_data_national_origin_ousideUS$continious_age,
                                                   HRS2014_data_national_origin_ousideUS$assessed_BMI)


nrow_2014 = nrow(HRS2014_data_national_origin_ousideUS) 
HRS2014_data_national_origin_ousideUS$year_2014 = rep(2014, times = nrow_2014)

HRS2014_data_national_origin_ousideUS <- na.omit(HRS2014_data_national_origin_ousideUS)

HRS2016_data_national_origin_ousideUS$HHIDPN_HRS2016 = HRS2016_data_national_origin_ousideUS$HHIDPN


HRS2016_data_national_origin_ousideUS = data_frame(HRS2016_data_national_origin_ousideUS$HHIDPN,
                                                   HRS2016_data_national_origin_ousideUS$diabetes_new,
                                                   HRS2016_data_national_origin_ousideUS$diabetes_ever,
                                                   HRS2016_data_national_origin_ousideUS$sex_1_2,
                                                   HRS2016_data_national_origin_ousideUS$wealth_noIRA,
                                                   
                                                   HRS2016_data_national_origin_ousideUS$start,
                                                   HRS2016_data_national_origin_ousideUS$stop,
                                                   
                                                   HRS2016_data_national_origin_ousideUS$reason_discrim1_reason_disability,
                                                   
                                                   HRS2016_data_national_origin_ousideUS$discrim_harassed,
                                                   HRS2016_data_national_origin_ousideUS$discrim_lessrespect,
                                                   HRS2016_data_national_origin_ousideUS$discrim_medical,
                                                   HRS2016_data_national_origin_ousideUS$discrim_notclever,
                                                   HRS2016_data_national_origin_ousideUS$discrim_poorerservice,
                                                   HRS2016_data_national_origin_ousideUS$discrim_afraidothers,
                                                   
                                                   HRS2016_data_national_origin_ousideUS$continious_age,
                                                   HRS2016_data_national_origin_ousideUS$assessed_BMI)

nrow_2016 = nrow(HRS2016_data_national_origin_ousideUS) 
HRS2016_data_national_origin_ousideUS$year_2016 = rep(2016, times = nrow_2016)

HRS2016_data_national_origin_ousideUS <- na.omit(HRS2016_data_national_origin_ousideUS)



HRS2018_data_national_origin_ousideUS$HHIDPN = HRS2018_data_national_origin_ousideUS$HHIDPN_HRS2018


HRS2018_data_national_origin_ousideUS = data_frame(HRS2018_data_national_origin_ousideUS$HHIDPN,
                                                   HRS2018_data_national_origin_ousideUS$diabetes_new,
                                                   HRS2018_data_national_origin_ousideUS$diabetes_ever,
                                                   HRS2018_data_national_origin_ousideUS$sex_1_2,
                                                   HRS2018_data_national_origin_ousideUS$wealth_noIRA,
                                                   
                                                   HRS2018_data_national_origin_ousideUS$start,
                                                   HRS2018_data_national_origin_ousideUS$stop,
                                                   
                                                   HRS2018_data_national_origin_ousideUS$reason_discrim1_reason_disability,
                                                   
                                                   HRS2018_data_national_origin_ousideUS$discrim_harassed,
                                                   HRS2018_data_national_origin_ousideUS$discrim_lessrespect,
                                                   HRS2018_data_national_origin_ousideUS$discrim_medical,
                                                   HRS2018_data_national_origin_ousideUS$discrim_notclever,
                                                   HRS2018_data_national_origin_ousideUS$discrim_poorerservice,
                                                   HRS2018_data_national_origin_ousideUS$discrim_afraidothers,
                                                   
                                                   HRS2018_data_national_origin_ousideUS$continious_age, 
                                                   HRS2018_data_national_origin_ousideUS$assessed_BMI)

nrow_2018 = nrow(HRS2018_data_national_origin_ousideUS) 
HRS2018_data_national_origin_ousideUS$year_2018= rep(2018, times = nrow_2018)
...
colnames(HRS2008_data_national_origin_ousideUS) = colnames_all
colnames(HRS2010_data_national_origin_ousideUS) = colnames_all
colnames(HRS2012_data_national_origin_ousideUS) = colnames_all
colnames(HRS2014_data_national_origin_ousideUS) = colnames_all
colnames(HRS2016_data_national_origin_ousideUS) = colnames_all
colnames(HRS2018_data_national_origin_ousideUS) = colnames_all



WCE_dataset_national_origin_ousideUS = rbind(HRS2008_data_national_origin_ousideUS, HRS2010_data_national_origin_ousideUS, HRS2012_data_national_origin_ousideUS, HRS2014_data_national_origin_ousideUS, HRS2016_data_national_origin_ousideUS, HRS2018_data_national_origin_ousideUS)


WCE_dataset_national_origin_ousideUS$diabetes_new_bin = case_when(WCE_dataset_national_origin_ousideUS$diabetes_new ==0 ~ 0, 
...
write.csv(WCE_dataset_national_origin_ousideUS, paste(SOURCE_ROOT, "WCE_dataset_national_origin_ousideUS.csv", sep=""))

#which(WCE_dataset_national_origin_ousideUS, WCE_dataset_national_origin_ousideUS$HHIDPN== 3020)

nrow(WCE_dataset_national_origin_ousideUS)
head(WCE_dataset_national_origin_ousideUS)

ID = unique(WCE_dataset_national_origin_ousideUS$HHIDPN)

#print(isTRUE(WCE_dataset_national_origin_ousideUS$HHIDPN == ID[1]))
WCE_dataset_national_origin_ousideUS = WCE_dataset_national_origin_ousideUS %>% drop_na()
...
for (id in ID){
  print(n)
  print(id)
  participant_wave = subset(WCE_dataset_national_origin_ousideUS, WCE_dataset_national_origin_ousideUS$HHIDPN == id)
...
participant_wave_df$discrim_harassed
...
write.csv(participant_wave_df, paste(SOURCE_ROOT, "participant_wave_df_national_origin.csv", sep=""))
