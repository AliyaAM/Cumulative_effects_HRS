...
#WCE_dataset_lim_cond = read.csv(paste(SOURCE_data_ROOT, "WCE_dataset_lim_cond_diabetes.csv", sep=""))
...
#################################### lim_cond ########################################################################
# # # # subset the data set to those with lim_cond
...
WCE_dataset_lim_cond$diabetes_new_bin = case_when(WCE_dataset_lim_cond$diabetes_new == 1 ~ 1, 
                                                  ...
                                                  WCE_dataset_lim_cond$diabetes_new == 3 ~ 1, 
                                                  WCE_dataset_lim_cond$diabetes_new == 4 ~ 0) 
...
WCE_dataset_lim_cond = WCE_dataset_lim_cond %>% drop_na(discrim_harassed_bin)
...
unique(data_wce_lim_cond$hypertension_new_bin)
...
lim_cond_discrim_harassed_bin_model_4_stats_recoded = lim_cond_discrim_harassed_bin_age[2]
...
write.csv(lim_cond_discrim_harassed_bin_model_4_stats_recoded, paste(OUTPUT_ROOT, "stats/lim_cond_overal_discrim_model_4_stats_recoded.csv", sep=""))
...
lim_cond_discrim_lessrespect_bin_model_4_stats_recoded = lim_cond_discrim_lessrespect_bin_age[2]
...
write.csv(lim_cond_discrim_lessrespect_bin_model_4_stats_recoded, paste(OUTPUT_ROOT, "stats/lim_cond_discrim_lessrespect_bin_model_4_stats_recoded.csv", sep=""))
...
lim_cond_discrim_medical_bin_model_4_stats_recoded = lim_cond_discrim_medical_bin_age[2]
...
lim_cond_discrim_notclever_bin_model_4_stats_recoded = lim_cond_discrim_notclever_bin_age[2]
...
lim_cond_discrim_poorerservice_bin_model_4_stats_recoded = lim_cond_discrim_poorerservice_bin_age[2]
...
lim_cond_afraid_others_model_4_stats_recoded = lim_cond_afraid_others_age[2]
