...
#WCE_dataset_national_origin_ousideUS.csv
#WCE_dataset_national_origin_ousideUS_ousideUS
#WCE_dataset_national_origin_ousideUS.csv
#WCE_dataset_national_origin_ousideUS.csv
...
#################################### ######## ########################################################################
# Model 1: age
# Model 2: age and national_origin_ousideUS 
# Model 3: age, national_origin_ousideUS, wealth,  (1)
# Model 4: age, national_origin_ousideUS, hypertension  (2)
# Model 5: age, national_origin_ousideUS, hypertension, wealth 
# Model 6: smoking, physical activity, alcohol consumption
# Model 7: age, national_origin_ousideUS,  smoking, physical activity, alcohol consumption  (3)
# Model 8:age, national_origin_ousideUS, smoking, physical activity, alcohol consumption, hypertension
# Model 9: age, national_origin_ousideUS, CVD  (4)
# Model 10: age, national_origin_ousideUS,CVD, hypertension 
# Model 11: age, national_origin_ousideUS, smoking, physical activity, alcohol consumption, CVD  
# Model 12: age, national_origin_ousideUS, smoking, physical activity, alcohol consumption, CVD, hypertension  (5)
# Model 13: age, national_origin_ousideUS, depression  (6)
# Model 14: age, national_origin_ousideUS, smoking, physical activity, alcohol consumption, depression (7)
# Model 15: age, national_origin_ousideUS, hypertension, depression 
# Model 16: age, national_origin_ousideUS,CVD, hypertension, depression 
# Model 17: age, national_origin_ousideUS, smoking, physical activity, alcohol consumption, CVD, hypertension, depression  (8)
#######
#age, sex, wealth, ethnicity, smoking, physical activity, alcohol consumption, national_origin_ousideUS, hypertension, CVD
...
HRS2008_data_national_origin_ousideUS_ousideUS = subset(HRS2008_data, HRS2008_data$national_origin_ousideUS_ousideUS == 1) 
HRS2010_data_national_origin_ousideUS_ousideUS = subset(HRS2010_data, HRS2010_data$national_origin_ousideUS_ousideUS == 1)
HRS2012_data_national_origin_ousideUS_ousideUS = subset(HRS2012_data, HRS2012_data$national_origin_ousideUS_ousideUS == 1)
HRS2014_data_national_origin_ousideUS_ousideUS = subset(HRS2014_data, HRS2014_data$national_origin_ousideUS_ousideUS == 1)
HRS2016_data_national_origin_ousideUS_ousideUS = subset(HRS2016_data, HRS2016_data$national_origin_ousideUS_ousideUS == 1)
HRS2018_data_national_origin_ousideUS_ousideUS = subset(HRS2018_data, HRS2018_data$national_origin_ousideUS_ousideUS == 1)
...
WCE_dataset_national_origin_ousideUS$CVD[WCE_dataset_national_origin_ousideUS$heartcondition_ever_bin == 1 | WCE_dataset_national_origin_ousideUS$heartcondition_new_bin == 1 | WCE_dataset_national_origin_ousideUS$angina_new_bin ==1 | WCE_dataset_national_origin_ousideUS$stroke_new_bin == 1 | WCE_dataset_national_origin_ousideUS$heartfailure2yrs_bin == 1 | WCE_dataset_national_origin_ousideUS$heartattack_ever_bin == 1 | WCE_dataset_national_origin_ousideUS$heartattack_new_bin == 1] <-1
WCE_dataset_national_origin_ousideUS$CVD[WCE_dataset_national_origin_ousideUS$heartcondition_ever_bin == 0 & WCE_dataset_national_origin_ousideUS$heartcondition_new_bin == 0 & WCE_dataset_national_origin_ousideUS$angina_new_bin ==0 & WCE_dataset_national_origin_ousideUS$stroke_new_bin == 0 & WCE_dataset_national_origin_ousideUS$heartfailure2yrs_bin == 0 & WCE_dataset_national_origin_ousideUS$heartattack_ever_bin == 0 & WCE_dataset_national_origin_ousideUS$heartattack_new_bin == 0] <-0
...
WCE_dataset_national_origin_ousideUS$vigarious_physical_activity_new = case_when(WCE_dataset_national_origin_ousideUS$vigarious_physical_activity == 1 ~ 5, 
                                                                 WCE_dataset_national_origin_ousideUS$vigarious_physical_activity == 2 ~ 4, 
                                                                 WCE_dataset_national_origin_ousideUS$vigarious_physical_activity == 3 ~ 3, 
                                                                 WCE_dataset_national_origin_ousideUS$vigarious_physical_activity == 4 ~ 2, 
                                                                 WCE_dataset_national_origin_ousideUS$vigarious_physical_activity == 5 ~ 1) 



WCE_dataset_national_origin_ousideUS$vigarious_physical_activity_bin = case_when(WCE_dataset_national_origin_ousideUS$vigarious_physical_activity_new == 5 ~ 1, 
                                                                 WCE_dataset_national_origin_ousideUS$vigarious_physical_activity_new == 4 ~ 1, 
                                                                 WCE_dataset_national_origin_ousideUS$vigarious_physical_activity_new == 3 ~ 1, 
                                                                 WCE_dataset_national_origin_ousideUS$vigarious_physical_activity_new == 2 ~ 0, 
                                                                 WCE_dataset_national_origin_ousideUS$vigarious_physical_activity_new == 1 ~ 0) 

unique(WCE_dataset_national_origin_ousideUS$alcohol_days_week)


WCE_dataset_national_origin_ousideUS$alcohol_days_week_new =  na_if(WCE_dataset_national_origin_ousideUS$alcohol_days_week, 8)
WCE_dataset_national_origin_ousideUS$alcohol_days_week_new = na_if(WCE_dataset_national_origin_ousideUS$alcohol_days_week_new, 9) 

unique(WCE_dataset_national_origin_ousideUS$alcohol_days_week_new)
...
WCE_dataset_national_origin_ousideUS$alcohol_days_week_new = as.numeric(WCE_dataset_national_origin_ousideUS$alcohol_days_week_new)
WCE_dataset_national_origin_ousideUS$vigarious_physical_activity_new = as.numeric(WCE_dataset_national_origin_ousideUS$vigarious_physical_activity_new)
WCE_dataset_national_origin_ousideUS$smokes_now_bin = as.numeric(WCE_dataset_national_origin_ousideUS$smokes_now_bin)
...
national_origin_ousideUS_discrim_harassed_bin_model_11_stats_recoded = national_origin_ousideUS_discrim_harassed_bin_age[2]
...
write.csv(national_origin_ousideUS_discrim_harassed_bin_model_11_stats_recoded, paste(OUTPUT_ROOT, "stats/national_origin_ousideUS_overal_discrim_model_11_stats_recoded.csv", sep=""))
...
national_origin_ousideUS_discrim_lessrespect_bin_model_11_stats_recoded = national_origin_ousideUS_discrim_lessrespect_bin_age[2]
...
write.csv(national_origin_ousideUS_discrim_lessrespect_bin_model_11_stats_recoded, paste(OUTPUT_ROOT, "stats/national_origin_ousideUS_discrim_lessrespect_bin_model_11_stats_recoded.csv", sep=""))
...
national_origin_ousideUS_discrim_medical_bin_model_11_stats_recoded = national_origin_ousideUS_discrim_medical_bin_age[2]
...
write.csv(national_origin_ousideUS_discrim_medical_bin_model_11_stats_recoded, paste(OUTPUT_ROOT, "stats/national_origin_ousideUS_discrim_medical_bin_model_11_stats_recoded.csv", sep=""))
...
national_origin_ousideUS_discrim_notclever_bin_model_11_stats_recoded = national_origin_ousideUS_discrim_notclever_bin_age[2]
...
write.csv(national_origin_ousideUS_discrim_notclever_bin_model_11_stats_recoded, paste(OUTPUT_ROOT, "stats/national_origin_ousideUS_discrim_notclever_bin_model_11_stats_recoded.csv", sep=""))
...
national_origin_ousideUS_discrim_poorerservice_bin_model_11_stats_recoded = national_origin_ousideUS_discrim_poorerservice_bin_age[2]
...
write.csv(national_origin_ousideUS_discrim_poorerservice_bin_model_11_stats_recoded, paste(OUTPUT_ROOT, "stats/national_origin_ousideUS_discrim_poorerservice_bin_model_11_stats_recoded.csv", sep=""))
...
national_origin_ousideUS_afraid_others_model_11_stats_recoded = national_origin_ousideUS_afraid_others_age[2]
...
write.csv(national_origin_ousideUS_afraid_others_model_11_stats_recoded, paste(OUTPUT_ROOT, "stats/national_origin_ousideUS_afraid_others_model_11_stats_recoded.csv", sep=""))
...
write.csv(national_origin_ousideUS_all_results, paste(OUTPUT_ROOT, "national_origin_ousideUS_all_results_bin_model_11_test.csv", sep=""))
