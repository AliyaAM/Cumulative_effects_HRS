...
race_discrim_bin_Model_1 = summary_score_WCE_analysis(data_WCE = data_wce_race,
                                                           exposure = "discrim_bin", 
                                                           outcome = "diabetes_new_bin", 
                                                           covariates_list = Model_1)


race_discrim_bin_HR_Model_1 = race_discrim_bin_Model_1[1]

race_discrim_bin_Model_1_stats_recoded = race_discrim_bin_Model_1[2]
...
race_discrim_bin_age_CI_Model_1  = summary_score_Bootstrapped_CI(WCE_data_CI = data_wce_race,
                                                                  exposure = "discrim_bin", 
                                                                  outcome = "diabetes_new_bin",
                                                                 covariates_list = Model_1)


write.csv(race_discrim_bin_Model_1_stats_recoded, paste(OUTPUT_ROOT, "stats/race_discrim_BIN_Model_1_stats.csv", sep=""))


race_discrim_bin_HR_Model_1 = unlist(race_discrim_bin_HR_Model_1)
race_discrim_bin_results_Model_1 = cbind(race_discrim_bin_HR_Model_1, race_discrim_bin_age_CI_Model_1)

colnames(race_discrim_bin_results_Model_1) = c("hazard ratio", "5% CI", "95% CI")



write.csv(race_discrim_bin_results_Model_1, paste(OUTPUT_ROOT, "stats/race_discrim_BIN_results_Model_1.csv", sep=""))
