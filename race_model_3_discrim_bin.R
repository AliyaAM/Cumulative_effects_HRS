...
race_discrim_bin_Model_3 = summary_score_WCE_analysis(data_WCE = data_wce_race,
                                                      exposure = "discrim_bin", 
                                                      outcome = "diabetes_new_bin", 
                                                      covariates_list = Model_3)


race_discrim_bin_HR_Model_3 = race_discrim_bin_Model_3[1]

race_discrim_bin_Model_3_stats_recoded = race_discrim_bin_Model_3[2]
...
race_discrim_bin_age_CI_Model_3  = summary_score_Bootstrapped_CI(WCE_data_CI = data_wce_race,
                                                                 exposure = "discrim_bin", 
                                                                 outcome = "diabetes_new_bin",
                                                                 covariates_list = Model_3)


write.csv(race_discrim_bin_Model_3_stats_recoded, paste(OUTPUT_ROOT, "stats/race_discrim_BIN_Model_3_stats.csv", sep=""))


race_discrim_bin_HR_Model_3 = unlist(race_discrim_bin_HR_Model_3)
race_discrim_bin_results_Model_3 = cbind(race_discrim_bin_HR_Model_3, race_discrim_bin_age_CI_Model_3)

colnames(race_discrim_bin_results_Model_3) = c("hazard ratio", "5% CI", "95% CI")



write.csv(race_discrim_bin_results_Model_3, paste(OUTPUT_ROOT, "race_discrim_BIN_results_Model_3.csv", sep=""))
